  ...
  return (
    <div className="flex justify-center items-start min-h-dvh bg-surface-bg bg-cover bg-center bg-no-repeat bg-mobile-auth-default">
      ...
      >
        ...
        {/* Bottom nav — the gradient scrim spans the full viewport width
            (inset-x-0), not just the 390px content column, so its own
            rectangular edge doesn't show as a hard vertical line against
            the page background on any device wider than 390px (most
            Android phones, iPhone Pro Max models). The 390px-capped
            column now lives one level in, just to center the rounded
            white card itself. */}
        <nav
          className="fixed bottom-0 inset-x-0 z-30 bg-[linear-gradient(180deg,rgba(249,249,251,0)_0%,var(--color-surface-bg)_28%)]"
