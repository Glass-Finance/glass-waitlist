...
export default function JoinApprovedModal({ entry, onOpen, onDismiss }) {
  ...
  return (
    ...
    >
      <div className="border border-surface-container-border w-full max-w-[340px] bg-surface-container backdrop-blur-elevated-container rounded-[20px] py-7 px-6 text-center shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
