...
function FeatureCard({ icon, title, desc, illustration, entryDelay }) {
  ...
  return (
    ...
    >
      ...
      {/* Illustration */}
      <div
        className="solution-illus relative [height:clamp(160px,45vw,240px)] overflow-hidden"
      >
        <img
          src={lightBg}
          alt=""
        ...
        */}
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-30">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-[clamp(15px,2vw,17px)] text-black/60 max-w-[640px] mx-auto leading-[1.7]">
