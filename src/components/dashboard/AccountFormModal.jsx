...
const inputCls =
  "w-full h-16 min-h-8 border border-gray-300 px-4 py-1 rounded-lg text-placeholder text-gray-800 placeholder-gray-400 outline-none focus:border-[#002FA7] transition-all bg-white";
...
export default function AccountFormModal({
  ...
  return (
    <>
      ...
      <div
        onClick={onClose}
        className="fixed inset-0 z-70 bg-black/35 backdrop-blur-xs"
      />
