...
export function AdminPaymentModal({ item, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-full bg-surface-container backdrop-blur-elevated-container rounded-2xl overflow-hidden shadow-2xl border border-surface-container-border max-w-[560px] max-h-[90vh] overflow-y-auto"
      >
        {/* ── Header ── */}
