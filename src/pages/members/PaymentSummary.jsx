...
function MastercardIcon() {
  return (
    <svg width="32" height="20" viewBox="0 0 32 20" fill="none">
      ...
      <path
        d="M16 4.27a7 7 0 0 1 0 11.46A7 7 0 0 1 16 4.27z"
        fill="#FF5F00"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <span
        ...
        style={{ background: on ? "#1C2B8A" : "#D1D5DB" }}
      />
      <span
      ...
      <div className="flex flex-col gap-3 px-4 pt-2">
        ...
        <div className="bg-white rounded-2xl px-4 py-4">
          ...
          <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
            ...
            <span className="text-[14px] font-semibold text-gray-900">{community.name}</span>
          </div>
          ...
          <div className="flex items-center justify-between py-3.5 border-b border-gray-100">
            ...
            <button className="text-[13px] font-semibold cursor-pointer" style={{ color:"#1C2B8A" }}>
              Change
            </button>
          </div>
          ...
          <div className="flex items-center justify-between pt-3.5">
            <div className="flex items-center gap-1.5">
              <span className="text-[13px] text-gray-600">Automatic Payment</span>
        ...
        {/* ── Card 2: Plan details ── */}
        <div className="bg-white rounded-2xl px-4 py-4">
          <p className="text-[14px] font-semibold text-gray-900 mb-4">Plan Details</p>
          ...
          <div className="flex items-center justify-between mb-2.5">
            ...
            <span className="text-[14px] text-gray-900">{fmt(plan.amount)}</span>
          </div>

          {/* Charge */}
          <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-100">
            <span className="text-[13px] text-gray-500">Charge:</span>
            <span className="text-[14px] text-gray-900">{fmt(plan.charge)}</span>
          </div>

          {/* Total */}
          <div className="flex items-center justify-between">
            <span className="text-[13px] text-gray-500">Total:</span>
            <span className="text-[15px] font-bold text-gray-900">{fmt(plan.total)}</span>
          </div>
        </div>
        ...
        <button
          onClick={handlePay}
          disabled={loading}
          className="w-full rounded-2xl py-4 text-[15px] font-semibold text-white mt-1 cursor-pointer active:scale-[0.98] transition-all disabled:opacity-80"
