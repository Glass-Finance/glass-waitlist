...
const inputCls = "w-full h-16 min-h-8 py-1 px-6 rounded-lg border border-[#E0E0E0] text-sm text-[#111] outline-none bg-white box-border transition-all focus:border-[#002FA7]";
