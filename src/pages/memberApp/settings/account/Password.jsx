...
const inputCls = "w-full h-12 min-h-8 py-1 pl-4 pr-10 rounded-lg border border-[#E0E0E0] text-placeholder text-[#111] outline-none bg-white box-border transition-all focus:border-[#002FA7]";
