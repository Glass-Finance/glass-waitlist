...
const inputCls =
  "w-full h-12 min-h-8 border border-gray-200 px-4 py-1 rounded-lg text-placeholder text-gray-800 placeholder-gray-400 outline-none focus:border-[#002FA7] transition-all";
