    ...
    <div className="h-screen w-screen flex flex-col overflow-hidden" style={{ background: "#E5E5E5" }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-10 overflow-y-auto">
        <div className="w-full max-w-xl flex flex-col items-center">
          ...
          <QRCodeCanvas value={joinUrl} size={250} color="#000000" />

          <button
            onClick={() => navigate("/dashboard/home")}
            className="w-full max-w-xl mt-8 py-3.5 rounded-full text-white text-sm font-medium transition-all hover:opacity-90 active:scale-[0.98] border-none cursor-pointer"
