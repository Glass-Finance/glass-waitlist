...
export const inputCls =
  "w-full h-12 min-h-8 px-4 py-1 rounded-lg border border-gray-200 text-placeholder text-gray-700 bg-white outline-none transition-all focus:border-[#002FA7]";
