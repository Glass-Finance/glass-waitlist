            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-y border-gray-100 bg-[#F9F9FB]">
                  ...
                  <th className="hidden xl:table-cell px-5 py-2.5 text-left text-xs font-normal text-gray-400 whitespace-nowrap">
                    Email
                  </th>
                  <th className="hidden xl:table-cell px-5 py-2.5 text-left text-xs font-normal text-gray-400 whitespace-nowrap">
                    Date Joined
                  ...
                  filtered.map((m) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="hidden md:table-cell px-5 py-3 text-xs text-gray-500">
                          {formatDate(m.lastPaymentDate)}
                        </td>
                        <td className="hidden xl:table-cell px-5 py-3 text-xs text-gray-500">
                          {memberEmail(m)}
                        </td>
                        <td className="hidden xl:table-cell px-5 py-3 text-xs text-gray-500">
