  ...
  return (
    <div className="flex flex-col gap-4" >
      ...
      {deleteModal && (
        ...
        >
          <div className="bg-surface-container backdrop-blur-elevated-container rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-surface-container-border">
            <div
            ...
            <input
              ...
              className="w-full h-12 min-h-8 border border-gray-300 px-4 py-1 rounded-lg text-placeholder outline-none focus:border-red-400 mb-4 transition-all"
            />
