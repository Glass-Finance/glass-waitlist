  ...
  return (
    <div className="max-w-2xl flex flex-col gap-5">
      ...
      <div className="bg-white rounded-2xl p-6" style={{ border: "1px solid #E5E7EB" }}>
        ...
        <p className="text-xs text-gray-500 mb-5">Define Your Membership and Payment participation</p>
            ...
            return (
              ...
              >
                ...
                <div className={`w-5 h-5 rounded-full flex-shrink-0 mt-0.5 flex items-center justify-center
                  ...
                  style={{ border: isSelected ? "none" : "2px solid #D1D5DB" }}
                >
      ...
      {/* Info banner */}
      <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-blue-50" style={{ border: "1px solid #BFDBFE" }}>
        <div className="w-4 h-4 rounded-full bg-[#002FA7] flex items-center justify-center flex-shrink-0">
