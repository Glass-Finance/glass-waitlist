...
export default function Profile() {
  ...
  const inputCls =
    "w-full h-12 min-h-8 px-4 py-1 rounded-lg bg-white text-gray-900 text-placeholder outline-none transition-all border focus:border-[#002FA7]";
            ...
            {deleteStep === "warn" ? (
              <>
                ...
                <input
                  ...
                  placeholder="DELETE"
                  className="w-full h-12 min-h-8 border border-gray-300 px-4 py-1 rounded-lg text-placeholder outline-none focus:border-red-400 mb-4 transition-all bg-white"
                />
