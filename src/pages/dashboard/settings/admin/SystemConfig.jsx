        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
          ...
          <div>
            ...
            {isBool ? (
              ...
              <input
                ...
                className="w-full h-16 min-h-8 px-6 py-1 rounded-lg text-xs text-gray-800 outline-none transition-colors border border-[#D0D0D0] focus:border-[#002FA7]"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full h-16 min-h-8 px-6 py-1 rounded-lg text-xs text-gray-800 outline-none transition-colors resize-none border border-[#D0D0D0] focus:border-[#002FA7]"
