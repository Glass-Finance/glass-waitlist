...
| `VITE_FLAGS`                     | No                      | JSON feature/kill-switch map, e.g. `{"paymentsDisabled":true}` — blocks every payment-initiation button after a redeploy. See `docs/runbooks/incident-rollback.md`.                                                                                                                                                                                                                                  |
